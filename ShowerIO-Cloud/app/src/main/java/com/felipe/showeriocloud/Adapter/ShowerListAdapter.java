...
public class ShowerListAdapter extends RecyclerView.Adapter<ShowerListAdapter.MyViewHolder> {
    ...
    private List<DeviceDO> showerDevices;
    ...
    public ShowerListAdapter(Context context, List<DeviceDO> showerDevices) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final DeviceDO showerDevice = showerDevices.get(position);
        String showerName;
    ...
    public void restoreShowerDevice(DeviceDO showerDevice, int position) {
